...
public abstract class FactoryBaseValidator {
    ...
    protected void validateProjectActions(FactoryDto factory) throws BadRequestException {
        ...
        final List<ActionDto> applicationActions = new ArrayList<>();
        ...
        for (ActionDto applicationAction : applicationActions) {
        ...
        if (onAppLoaded != null) {
            for (ActionDto action : onAppLoaded.getActions()) {
        ...
        if (onLoaded != null) {
            final List<ActionDto> onProjectOpenedActions = onLoaded.getActions();
            for (ActionDto applicationAction : onProjectOpenedActions) {
