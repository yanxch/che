...
public class DockerRegistryAuthResolverTest {
    ...
    public void shouldGetXRegistryAuthHeaderValueFromInitialAuthConfigOnly1() {
        String base64HeaderValue = authResolver.getXRegistryAuthHeaderValue(INITIAL_REGISTRY1_URL, null);
    ...
    public void shouldGetXRegistryAuthHeaderValueFromInitialAuthConfigOnly2() {
        String base64HeaderValue = authResolver.getXRegistryAuthHeaderValue(INITIAL_REGISTRY2_URL, null);
    ...
    public void shouldGetXRegistryAuthHeaderValueFromInitialAuthConfigOnly3() {
        String base64HeaderValue = authResolver.getXRegistryAuthHeaderValue(INITIAL_REGISTRY3_URL, null);
    ...
    @Test
    public void shouldReturnEmptyEncodedJsonIfRegistryNotFoundInInitialAuthConfigAndCustomConfigIsNull() {
        String base64HeaderValue = authResolver.getXRegistryAuthHeaderValue(UNKNOWN_REGISTRY, null);

        assertEqualsXRegistryAuthHeader(base64ToAuthConfig(base64HeaderValue),
                                        jsonToAuthConfig(EMPTY_JSON));
    }
    ...
    @Test
    public void shouldReturnEmptyEncodedJsonIfRegistryNotFoundInCustomAuthConfigAndInitialAuthConfigIsNull() {
        when(initialAuthConfig.getAuthConfigs()).thenReturn(emptyAuthConfigs);

        String base64HeaderValue = authResolver.getXRegistryAuthHeaderValue(UNKNOWN_REGISTRY, customAuthConfigs);
    ...
    @Test
    public void shouldGetXRegistryAuthConfigFromCustomAuthConfigIfSpecifiedRegistryExistsInBothConfigs() {
    ...
    public void shouldGetXRegistryAuthConfigValue2() {
        String base64HeaderValue = authResolver.getXRegistryAuthHeaderValue(INITIAL_REGISTRY2_URL, customAuthConfigs);
    ...
    public void shouldGetXRegistryAuthConfigValue3() {
        String base64HeaderValue = authResolver.getXRegistryAuthHeaderValue(INITIAL_REGISTRY3_URL, customAuthConfigs);
    ...
    public void shouldAcceptDockerHubAlias2WhenGetXRegistryAuthValueFromInitialConfig() {
        ...
        String base64HeaderValue = authResolver.getXRegistryAuthHeaderValue(DEFAULT_REGISTRY_URL_ALIAS2, null);
    ...
    public void shouldAcceptDockerHubAlias3WhenGetXRegistryAuthValueFromInitialConfig() {
        ...
        String base64HeaderValue = authResolver.getXRegistryAuthHeaderValue(DEFAULT_REGISTRY_URL_ALIAS3, null);
    ...
    public void shouldAcceptDockerHubAlias2WhenGetXRegistryAuthValueFromCustomConfig() {
        ...
        String base64HeaderValue = authResolver.getXRegistryAuthHeaderValue(DEFAULT_REGISTRY_URL_ALIAS2, dockerHubAuthConfigs);
    ...
    public void shouldGetXRegistryConfigValueFromInitialAuthConfigIfCustomAuthConfigIsNull() {
        ...
        assertEqualsXRegistryConfigHeader(base64ToAuthConfigs(base64HeaderValue),
                                          jsonToAuthConfigs(INITIAL_X_AUTH_CONFIG_VALUE));
    }
    ...
    public void shouldGetXRegistryConfigValueFromCustomAuthConfigIfInitialAuthConfigIsNull() {
        ...
        assertEqualsXRegistryConfigHeader(base64ToAuthConfigs(base64HeaderValue),
                                          jsonToAuthConfigs(CUSTOM_X_AUTH_CONFIG_VALUE));
    }
    ...
    public void shouldGetXRegistryConfigValue() {
        ...
        assertEqualsXRegistryConfigHeader(base64ToAuthConfigs(base64HeaderValue),
                                          jsonToAuthConfigs(X_AUTH_CONFIG_VALUE));
    }

    @Test
    public void shouldReplaceDockerHubAliasDockerIoToFullUrlWhenGetXRegistryConfigValueFromInitialConfig() {
        when(initialAuthConfig.getAuthConfigs()).thenReturn(dockerHubAuthConfigs);
    ...
    @Test
    public void shouldReplaceDockerHubAliasDockerIoToFullUrlWhenGetXRegistryConfigValueFromCustomConfig() {
        when(initialAuthConfig.getAuthConfigs()).thenReturn(emptyAuthConfigs);
