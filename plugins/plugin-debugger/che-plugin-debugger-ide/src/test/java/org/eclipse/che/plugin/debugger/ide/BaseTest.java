...
public abstract class BaseTest {
    ...
    @Before
    public void setUp() {
        when(debugSession.getDebuggerInfo()).thenReturn(debuggerInfo);
        when(debugSession.getId()).thenReturn(DEBUGGER_ID);
        when(debugSession.getType()).thenReturn(DEBUGGER_TYPE);
