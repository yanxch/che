...
public interface Debugger {
     ...
     * Must be fired {@link org.eclipse.che.api.debugger.shared.dto.events.DisconnectEvent} if succeeded.
     *
     * @throws DebuggerException
     *      if any error occur
     */
     ...
     * When process stops then {@link org.eclipse.che.api.debugger.shared.dto.events.SuspendEvent} must be fired.
     *
     * @param action
     ...
     * then {@link org.eclipse.che.api.debugger.shared.dto.events.BreakpointActivatedEvent} must be fired. If breakpoint becomes
     ...
     *      if any error occur
     */
    Value getValue(VariablePath variablePath) throws DebuggerException;
