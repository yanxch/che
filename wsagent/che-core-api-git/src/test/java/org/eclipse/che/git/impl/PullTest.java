...
public class PullTest {
    ...
    public void testPullRemote(GitConnectionFactory connectionFactory)
        ...
        connection2.add(AddParams.create(Arrays.asList(".")));
        connection2.commit(CommitParams.create("init"));

        //when
        connection2.pull(PullParams.create(connection.getWorkingDir().getAbsolutePath()).withRefSpec(branchName));
        //then
